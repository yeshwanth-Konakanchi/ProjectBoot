 ...
 * @author Ross
 */
public class XmlTransactionDemo {
	private final static Log log = LogFactory.getLog(XmlTransactionDemo.class);
	
	public static void main(String[] args) {
		log.info("-- Starting Spring Declarative XML Example --");
		ClassPathXmlApplicationContext ctx = new ClassPathXmlApplicationContext("xml-test.xml");
