...
import com.psbparks.tenantinformationportal.entity.Building;
...
public class TenantInformationPortalController {
	...
	public void getTenantMockData() {
		...
		for (;; ) {
			...
			System.out.println("Enter 'YES' to continue or else type 'NO' to retrieve the details");
			i++;
			}
			else{
				break;
	...
	public void displayTenantData() {
		...
		Scanner scan = new Scanner(System.in);
		System.out.println("Enter Building name to get the tenant information: ");
		String buildingName = scan.nextLine();
		ArrayList<Company> tenantInfo = tenantInformation.displayTenantInfo(buildingName);
		System.out.println("Here's the list of all the companies with the buildingName: "+ buildingName);
